...
export default function SortableContents({ setAttributes, contentLists, ucFirst }) {
    const onSortEnd = ({ newIndex, oldIndex }) => {
        setAttributes({ enableContents: arrayMove(contentLists, oldIndex, newIndex) });
    };

    return <SortableList contentLists={contentLists} onSortEnd={onSortEnd} ucFirst={ucFirst} useDragHandle />;
}
