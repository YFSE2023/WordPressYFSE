        ...
        switch (preset) {
            ...
            case "preset1":
                setAttributes({
                    ...
                    cSepColor: "var(--eb-global-primary-color)",
                    dscP_Left: "20",
                    dscP_Right: "20",
            ...
            <div className="eb-panel-control">
				...
				div.${blockId}.eb-team-wrapper div.contents {
					opacity: 1;
                                    ...
                                    <PanelBody title={__("Name", "essential-blocks")} initialOpen={false}>
                                        <ColorControl
                                    ...
                                    <PanelBody title={__("Description", "essential-blocks")} initialOpen={false}>
                                        <ToggleControl
