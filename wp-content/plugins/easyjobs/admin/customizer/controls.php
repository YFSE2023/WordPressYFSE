 ...
 * 
 * Class Easyjobs_Customizer_Range_Value_Control
 *
 * @since 1.0.0
 */
class Easyjobs_Customizer_Range_Value_Control extends WP_Customize_Control {
	public $type = 'easyjobs-range-value';
	...
	public function enqueue() {
		wp_enqueue_script(
			'easyjobs-customizer-range-value-control',
			EASYJOBS_ADMIN_URL . 'assets/dist/js/customizer-range-value-control.js',
			array( 'jquery' ),
			rand(),
			true
		);
		...
		wp_enqueue_style( 
			'easyjobs-customizer-range-value-control', EASYJOBS_ADMIN_URL . 'assets/dist/css/customizer-range-value-control.css',
			array(),
			rand()
		);
	}
...
class Easyjobs_Customizer_Alpha_Color_Control extends WP_Customize_Control {
	 ...
	 */
	public function render_content() {
		echo '<div class="easyjobs-alpha-color-picker">';
		...
		// Begin the output. 
		?>
		<input class="easyjobs-alpha-color-control" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" data-default-color="<?php echo esc_attr( $this->settings['default']->default ); ?>" <?php esc_attr( $this->link() ); ?>  />
...
class Easyjobs_Customizer_Gradient_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script(
			'easyjobs-customizer-gradient-control',
			EASYJOBS_ADMIN_URL . 'assets/dist/js/customizer-gradient-control.js',
			array( 'jquery' ),
			rand(),
			true
		);
	 ...
	 */
	public function render_content() {
		echo '<div class="easyjobs-gradient-color-control">';
		// Output the label and description if they were passed in.
		if ( isset( $this->label ) && '' !== $this->label ) {
			echo '<span class="customize-control-title">' . sanitize_text_field( $this->label ) . '</span>';
		}
		...
		?>
		<input type="hidden" value="" class="easyjobs-gradient-color <?php echo esc_attr($this->id) ?>" value="" data-customize-setting-link="<?php echo esc_attr($this->id); ?>">
		<ul>
			<li class="customize-control customize-control-gradient customize-control-gradient-color-1">
				 <div class="gradient-color-plate color-plate-left">
					<label class="gradient-control-label"><?php esc_html_e('Color 1','easyjobs') ?></label>
					<input class="easyjobs-alpha-color-control gradient-control-field gradient-control-color-1" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" value="<?php echo $gradient_val['color1'] ?>" />
				</div>
				<div class="gradient-color-plate color-plate-right">
					<label class="gradient-control-label"><?php esc_html_e('%','easyjobs') ?></label>
			...
			<li class="customize-control customize-control-gradient customize-control-gradient-color-2">
				 <div class="gradient-color-plate color-plate-left">
					<label class="gradient-control-label"><?php esc_html_e('Color 2','easyjobs') ?></label>
					<input class="easyjobs-alpha-color-control gradient-control-field gradient-control-color-2" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" value="<?php echo $gradient_val['color2'] ?>" />	
				</div>
				<div class="gradient-color-plate color-plate-right">
					<label class="gradient-control-label"><?php esc_html_e('%','easyjobs') ?></label>
			...
			<li class="customize-control customize-control-gradient customize-control-gradient-color-3">
				 <div class="gradient-color-plate color-plate-left">
					<label class="gradient-control-label"><?php esc_html_e('Color 3','easyjobs') ?></label>
					<input class="easyjobs-alpha-color-control gradient-control-field gradient-control-color-3" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" value="<?php echo $gradient_val['color3'] ?>" />
				</div>
				<div class="gradient-color-plate color-plate-right">
					<label class="gradient-control-label"><?php esc_html_e('%','easyjobs') ?></label>
			...
			<li class="customize-control customize-control-gradient customize-control-gradient-color-4">
				 <div class="gradient-color-plate color-plate-left">
					<label class="gradient-control-label"><?php esc_html_e('Color 4','easyjobs') ?></label>
					<input class="easyjobs-alpha-color-control gradient-control-field gradient-control-color-4" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" value="<?php echo $gradient_val['color4'] ?>" />
				</div>
				<div class="gradient-color-plate color-plate-right">
					<label class="gradient-control-label"><?php esc_html_e('%','easyjobs') ?></label>
			...
			<li class="customize-control customize-control-gradient">
				<label class="gradient-control-label"><?php esc_html_e('Direction','easyjobs') ?></label>
			...
			<li class="customize-control">
				<label class="gradient-control-label"><?php esc_html_e('Angle','easyjobs') ?></label>
...
class Easyjobs_Number_Control extends WP_Customize_Control {
	public $type = 'easyjobs-number';
	...
	public function render_content() {
		?>
		<div class="number-field easyjobs-number-field <?php echo !empty($this->input_attrs['suffix']) ? 'has-suffix': '';?>" id="<?php echo $this->id; ?>">
			<?php if ( ! empty( $this->label ) ) : ?>
			<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
			<a href="#" title="<?php echo esc_html__('Reset', 'easyjobs') ?>" class="easyjobs-customizer-reset <?php echo esc_html( $this->type ); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="20px"><path d="M 25 2 C 12.321124 2 2 12.321124 2 25 C 2 37.678876 12.321124 48 25 48 C 37.678876 48 48 37.678876 48 25 A 2.0002 2.0002 0 1 0 44 25 C 44 35.517124 35.517124 44 25 44 C 14.482876 44 6 35.517124 6 25 C 6 14.482876 14.482876 6 25 6 C 30.475799 6 35.391893 8.3080175 38.855469 12 L 35 12 A 2.0002 2.0002 0 1 0 35 16 L 46 16 L 46 5 A 2.0002 2.0002 0 0 0 43.970703 2.9726562 A 2.0002 2.0002 0 0 0 42 5 L 42 9.5253906 C 37.79052 4.9067015 31.727675 2 25 2 z"></path></svg></a>
			<?php endif; ?>
            ...
            <?php if(!empty($this->input_attrs['suffix'])):?>
                <span class="customize-control-suffix"><?php echo $this->input_attrs['suffix']; ?></span>
            <?php endif?>
			<?php if ( ! empty( $this->description ) ) : ?>
			<span class="description customize-control-description"><?php echo $this->description; ?></span>
			<?php endif; ?>
...
class Easyjobs_Radio_Image_Control extends WP_Customize_Control {
	/**
	 * Declare the control type.
	 *
	 * @since 1.0.0
	 */
	public $type = 'easyjobs-radio-image';
	...
	public function enqueue() {
		...
		wp_enqueue_style(
			'easyjobs-customizer-radio-image-select',
			EASYJOBS_ADMIN_URL . 'assets/dist/css/customizer-radio-image-select.css',
			array(),
			rand()
		);
	}
	...
	public function render_content() {
		...
		<div id="input_<?php echo $this->id; ?>" class="image ui-buttonset">
			...
			foreach ( $this->choices as $value => $label ) :
				...
				<span class="go-pro"><?php esc_html_e('Go Pro','easyjobs') ?></span>
				</label>
				<?php } else { ?>
...
function easyjobs_customizer_condition() {
	wp_enqueue_script( 'easyjobs-customize-condition', 
		EASYJOBS_ADMIN_URL . 'assets/dist/js/customizer-condition.js',
		array(),'',
		true 
	);
}
add_action( 'customize_controls_enqueue_scripts', 'easyjobs_customizer_condition' );
