...
/**
 * Main SDK for WPInsights_Easyjobs.
 */
if ( ! class_exists( 'WPInsights_Easyjobs' ) ) :
    class WPInsights_Easyjobs {
        /**
         * WP Insights Version
         */
        ...
        /**
         * Instace of WPInsights_Easyjobs
         *
         * @var WPInsights_Easyjobs
         */
        private static $_instance = null;
        /**
         * Get Instance of WPInsights_Easyjobs
         *
         * @return WPInsights_Easyjobs
         */
        ...
        public function clicked() {
            if ( isset( $_GET['plugin'] ) && isset( $_GET['plugin_action'] ) ) {
                if ( isset( $_GET['tab'] ) && sanitize_text_field( $_GET['tab'] ) === 'plugin-information' ) {
                    return;
                }
        ...
        public function deactivate_reasons_form_style() {
            ?>
            <style type="text/css">
                .wpinsights-form-active-easyjobs .wpinsights-goodbye-form-bg {
                ...
                .wpinsights-goodbye-form-wrapper-easyjobs {
                    position: relative;
                    display: none;
                }

                .wpinsights-form-active-easyjobs .wpinsights-goodbye-form-wrapper-easyjobs {
                ...
                .wpinsights-form-active-easyjobs .wpinsights-goodbye-form {
                ...
                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-head {
                    background: #fff;
                    color: #495157;
                    padding: 18px;
                ...
                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form .wpinsights-goodbye-form-head strong {
                    font-size: 15px;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body {
                    padding: 8px 18px;
                    color: #333;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body label {
                    padding-left: 5px;
                    color: #6d7882;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body .wpinsights-goodbye-form-caption {
                    font-weight: 500;
                    font-size: 15px;
                    color: #495157;
                    line-height: 1.4;
                ...
                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body #wpinsights-goodbye-options {
                    padding-top: 5px;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body #wpinsights-goodbye-options ul>li {
                    margin-bottom: 15px;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body #wpinsights-goodbye-options ul>li>div {
                    display: inline;
                    padding-left: 3px;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body #wpinsights-goodbye-options ul>li>div>input,
                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-body #wpinsights-goodbye-options ul>li>div>textarea {
                    margin: 10px 18px;
                    padding: 8px;
                    width: 80%;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .deactivating-spinner {
                    display: none;
                    padding-bottom: 20px !important;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .deactivating-spinner .spinner {
                    float: none;
                ...
                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-footer {
                    padding: 8px 18px;
                    margin-bottom: 15px;
                }

                .wpinsights-goodbye-form-wrapper-easyjobs .wpinsights-goodbye-form-footer>.wpinsights-goodbye-form-buttons {
                    display: flex;
                    align-items: center;
                ...
                $("#wpinsights-goodbye-link-<?php echo $class_plugin_name; ?>").on("click",function(){
                  ...
                  $('#wpinsights-submit-form-<?php echo $class_plugin_name; ?>').on('click', function(e){
                    ...
                    var data = {
                      ...
                      'details': details,
                      'security': "<?php echo sanitize_key(wp_create_nonce( 'wpins_deactivation_nonce' )); ?>",
                      'dataType': "json"
                    }
