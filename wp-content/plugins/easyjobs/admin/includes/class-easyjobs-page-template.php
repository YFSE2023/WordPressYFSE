...
class Easyjobs_Page_Template {
    ...
    public static function get_instance() {
        ...
        if ( null == self::$instance ) {
            self::$instance = new Easyjobs_Page_Template();
        }
    ...
    private function __construct() {
        ...
        $this->templates = array(
            'easyjobs-template.php' => __( 'Easyjobs template', 'easyjobs' ),
        );
    ...
    public function view_template( $template ) {
        ...
        $file = EASYJOBS_PUBLIC_PATH . 'templates/' . get_post_meta(
            $post->ID,
            '_wp_page_template',
            true
        );
