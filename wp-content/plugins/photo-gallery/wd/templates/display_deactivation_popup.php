...
<div class="tenweb-deactivate-popup tenweb-<?php echo $wd_options->prefix; ?>-deactivate-popup">
  ...
  <form method="post" id="<?php echo $wd_options->prefix; ?>_deactivate_form">
    <div class="tenweb-deactivate-popup-header">
      <?php _e("Please let us know why you are deactivating. Your answer will help us to provide you support or sometimes offer discounts. (Optional)", 'photo-gallery'); ?>:
    ...
    <div class="tenweb-btns">
      <a href="<?php echo $deactivate_url; ?>" data-val="1" class="button button-secondary button-close" id="tenweb-<?php echo $wd_options->prefix; ?>-deactivate"><?php _e("Skip and Deactivate", 'photo-gallery'); ?></a>
      <a href="<?php echo $deactivate_url; ?>" data-val="2" class="button button-primary button-primary-disabled button-close tenweb-<?php echo $wd_options->prefix; ?>-deactivate" id="tenweb-<?php echo $wd_options->prefix; ?>-submit-and-deactivate"><?php _e("Submit and Deactivate", 'photo-gallery'); ?></a>
    </div>
