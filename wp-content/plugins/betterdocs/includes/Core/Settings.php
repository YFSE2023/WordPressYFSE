    ...
    public function settings_args() {
        ...
        $settings = [
            ...
            'tabs'          => apply_filters( 'betterdocs_settings_tabs', [
                ...
                'tab-import-export'    => apply_filters( 'betterdocs_settings_tab_import_export', [
                                                        ...
                                                        'import_docs_nested'  => [
                                                            ...
                                                            'fields'   => [
                                                                'import_docs' => array(
                                                                    ...
                                                                    'type'         => 'importerupload',
                                                                    'label'        => __('Import Docs', 'betterdocs'),
                                                                    'label_subtitle' => __( 'To import your Docs, please upload the .xml file here', 'betterdocs' ),
                                                                    'text'    => [
                                                    ...
                                                    'fields'          => [
                                                        'export_docs_nested'  => [
                                                            ...
                                                            'fields'   => apply_filters( 'betterdocs_export_fields', [
                                                                'export_type' => [
                                                                    'name'           => 'export_type',
                                                                    'label'          => __( 'Select Type', 'betterdocs' ),
                                                                    ...
                                                                    'search'         => true,
                                                                    'options'  => $this->normalize_options(
                                                                        apply_filters( 'betterdocs_export_type_options', [
