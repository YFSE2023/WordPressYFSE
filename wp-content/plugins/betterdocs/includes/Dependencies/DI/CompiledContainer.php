...
use WPDeveloper\BetterDocs\Dependencies\DI\Compiler\RequestedEntryHolder;
...
use WPDeveloper\BetterDocs\Dependencies\DI\Invoker\FactoryParameterResolver;
...
abstract class CompiledContainer extends Container
{
    ...
    protected function setDefinition(string $name, Definition $definition)
    {
        ...
        throw new \LogicException('You cannot set a definition at runtime on a compiled container. You can either put your definitions in a file, disable compilation or ->set() a raw value directly (PHP object, string, int, ...) instead of a PHP-WPDeveloper\BetterDocs\Dependencies\DI definition.');
    }
