...
use WPDeveloper\BetterDocs\Dependencies\PhpParser\Comment;
use WPDeveloper\BetterDocs\Dependencies\PhpParser\Node\Expr;
use WPDeveloper\BetterDocs\Dependencies\PhpParser\Node\Name;
use WPDeveloper\BetterDocs\Dependencies\PhpParser\Node\NullableType;
...
abstract class BuilderAbstract implements Builder {
    ...
    /**
     * Normalizes a name: Converts plain string names to WPDeveloper\BetterDocs\Dependencies\PhpParser\Node\Name.
     *
    ...
    protected function normalizeName($name) {
        ...
        throw new \LogicException('Name must be a string or an instance of WPDeveloper\BetterDocs\Dependencies\PhpParser\Node\Name');
    }
    ...
    /**
     * Normalizes a doc comment: Converts plain strings to WPDeveloper\BetterDocs\Dependencies\PhpParser\Comment\Doc.
     *
    ...
    protected function normalizeDocComment($docComment) {
        if ($docComment instanceof Comment\Doc) {
            ...
            throw new \LogicException('Doc comment must be a string or an instance of WPDeveloper\BetterDocs\Dependencies\PhpParser\Comment\Doc');
        }
    }
