...
<div class="feedback-form">
    <a
        <?php echo $flink_attribute; ?>>
			...
			<?php echo ( $flink_text ) ? $flink_text : __( 'Still stuck? How can we help?', 'betterdocs' ); ?>
		</a>
            ...
            <div class="modal-content">
                ...
                <?php
                    echo wp_sprintf(
                        ...
                        $feedback_title_tag,
                        ( $feedback_title ) ? stripslashes( $feedback_title ) : esc_html__( 'How can we help?', 'betterdocs' )
                    );
