 ...
 * @since 0.0.1
 */
class Better_Payment_Handler extends Controller{
    ...
    public static function stripe_button( $widget_id = '' , $settings = []) {
        ...
        echo wp_kses( $stripe_button_html,  (new Better_Payment_Handler())->bp_allowed_tags() );
    }
    ...
    public static function paystack_button( $widget_id = '' , $settings = []) {
        ...
        echo wp_kses( $paystack_button_html,  (new Better_Payment_Handler())->bp_allowed_tags() );
    }
