 ...
 */
class Better_Payment_Plugin_Usage_Tracker
{
    use Helper;
    ...
    public function get_data()
    {
        ...
        if (empty($plugin)) {
            $body['message'] .= __('We can\'t detect any plugin information. This is most probably because you have not included the code in the plugin main file.', 'better-payment');
    ...
    public function deactivate_reasons_form()
    {
        ...
        if (is_array($form['options'])) {
            ...
            foreach ($form['options'] as $option) {
                if (is_array($option)) {
                    ...
                    $id = $id . '_' . esc_attr( $class_plugin_name );
                    $html .= '<li class="has-goodbye-extra">';
                    $html .= '<input type="radio" name="wpinsights-' . esc_attr( $class_plugin_name ) . '-goodbye-options" id="' . $id . '" value="' . esc_attr($option['label']) . '">';
                    ...
                    $id = $id . '_' . esc_attr( $class_plugin_name );
                    $html .= '<li><input type="radio" name="wpinsights-' . esc_attr( $class_plugin_name ) . '-goodbye-options" id="' . $id . '" value="' . esc_attr($option) . '"> <label for="' . $id . '">' . esc_attr($option) . '</label></li>';
                }
            }
        ...
        $styles .= '.wpinsights-form-active-' . esc_attr( $class_plugin_name ) . ' .wpinsights-goodbye-form-bg {';
