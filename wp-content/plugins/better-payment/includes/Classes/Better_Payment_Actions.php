...
class Better_Payment_Actions {
    ...
    public function paypal_form_handle() {
        ...
        $el_settings_currency_symbol = \Better_Payment\Lite\Classes\Better_Payment_Handler::get_currency_symbols( esc_html($el_settings_currency) );
        ...
        Better_Payment_Handler::payment_create(
            [
                'amount'       => floatval( $_POST[ 'primary_payment_amount' ] ),
                'order_id'     => $order_id,
    ...
    public function better_payment_stripe_get_token() {
        ...
        if(!empty($settings['better_payment_form_currency_use_woocommerce']) && 'yes' === $settings['better_payment_form_currency_use_woocommerce'] &&
        !empty($settings['better_payment_form_currency_woocommerce'])){
            $el_settings_currency = $settings['better_payment_form_currency_woocommerce'];
        }
