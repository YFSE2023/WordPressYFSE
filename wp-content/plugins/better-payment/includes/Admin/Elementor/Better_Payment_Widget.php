...
class Better_Payment_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'better_payment_form_payment_source_notice', [
            ...
            'condition'       => [
                'better_payment_form_payment_source' => 'woocommerce' . ( ! class_exists('woocommerce') ? '' : 'exist' ),
            ],
        ] );
        ...
        $better_payment_helper = new \Better_Payment\Lite\Classes\Better_Payment_Helper();
    ...
    public function form_element_settings() {
        ...
        $form_fields_repeater->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Select an icon for this field (not applicable for primary field - Payment Amount).', 'better-payment' ),
        ...
        $form_fields_repeater->add_control(
            ...
            [
				'type' => Controls_Manager::RAW_HTML,
				'raw' => sprintf(
					esc_html__( 'Field is hidden if payment source is WooCommerce.', 'better-payment' ),
				),
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Form Buttons', 'better-payment' ),
                'type'        => Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'default'     => __( 'Proceed to Payment', 'better-payment' ),
                'label_block' => true,
                'ai' => [
                    'active' => false,
                ],
    ...
    public function form_sidebar_style() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .better-payment .dynamic-amount-section',
            ]
        );
    ...
    public function form_sidebar_text_style() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .dynamic-amount-section-inner .bp-dynamic-amount-section-title',
                'separator' => 'after',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Typography', 'better-payment' ),
                'selector'  => '{{WRAPPER}} .dynamic-amount-section-inner .bp-dynamic-amount-section-sub-title',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Typography', 'better-payment' ),
                'selector'  => '{{WRAPPER}} .dynamic-amount-section-inner .bp-dynamic-amount-section-amount',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Typography', 'better-payment' ),
                'selector'  => '{{WRAPPER}} .dynamic-amount-section-inner .bp-dynamic-amount-section-amount-summary',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'better_payment_form_layout!' => 'layout-1',
                ],
            ]
        );
    ...
    public function form_container_style() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => [ 'classic', 'gradient' ],
                'selector' => '{{WRAPPER}} .better-payment .form-content-section',
            ]
        );
    ...
    public function form_fields_style() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} .better-payment .form-content-section input',
            ]
        );
    ...
    public function form_button_style() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Border', 'better-payment' ),
                'default'  => '1px',
                'selector' => '{{WRAPPER}} .better-payment .payment-form-layout .button',
            ]
        );
    ...
    protected function render() {
        ...
        $response = Better_Payment_Handler::manage_response( $settings, $this->get_id() );
        if ( $response ) {
            return false;
        }
        ...
        $better_payment_form_layout = in_array($better_payment_form_layout, $this->better_payment_free_layouts()) ? $better_payment_form_layout : 'layout-1';
    ...
    public function render_amount_element( $settings ) {
        $layout_form_currency_symbol    = Better_Payment_Handler::get_currency_symbols( esc_html($settings[ 'better_payment_form_currency' ]) );
