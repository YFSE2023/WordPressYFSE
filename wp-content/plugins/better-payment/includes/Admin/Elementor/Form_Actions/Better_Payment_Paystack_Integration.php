 ...
 * @since 0.0.1
 */
class Better_Payment_Paystack_Integration extends Action_Base {
    ...
    public function register_settings_section( $widget ) {
        ...
        $widget->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'     => $better_payment_is_paystack_live ? esc_html($this->better_payment_global_settings['better_payment_settings_payment_paystack_live_secret']) : esc_html($this->better_payment_global_settings['better_payment_settings_payment_paystack_test_secret']),
                'ai' => [
                    'active' => false,
                ],
            ]
