 ...
 * @since 0.0.1
 */
class Better_Payment_Settings extends Controller
{
	...
	public function render_better_payment_admin_pages()
	{
		...
		$bp_admin_completed_transactions_count = Better_Payment_DB::get_transaction_count('', 'v2', 0, 'completed');
		$bp_admin_incomplete_transactions_count = Better_Payment_DB::get_transaction_count('', 'v2', 1, 'incomplete');
		...
		if ($template == 'better-payment-transactions') {
			...
			$bp_admin_filtered_all_transactions_count = Better_Payment_DB::get_transaction_count( $transaction_pagination_args, 'v2', 1);
			...
			$bp_admin_all_transactions = Better_Payment_DB::get_transactions($transaction_pagination_args, 0, 'v2', $fetchNullIfIncomplete);	
		}
	...
	public function admin_transaction_filter()
	{
		...
		$bp_admin_all_transactions = Better_Payment_DB::get_transactions($args, 0, 'v2', $fetchNullIfIncomplete);
		...
		$bp_admin_all_transactions_count = Better_Payment_DB::get_transaction_count($args, 'v2', $fetchNull);
		...
		$bp_admin_completed_transactions_count = Better_Payment_DB::get_transaction_count($args, 'v2', 0, 'completed');
		$bp_admin_incomplete_transactions_count = Better_Payment_DB::get_transaction_count($args, 'v2', 1, 'incomplete');
