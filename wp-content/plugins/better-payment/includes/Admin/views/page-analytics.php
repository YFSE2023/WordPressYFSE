    ...
    <div class="better-payment-analytics">
            <div class="analytics-page-content p-5 m-1">
                <div class="analytics-page-content-header">
                    ...
                    <div class="columns">
                        <div class="column">
                            <p class="pt-6"><a class="width-100" target="_blank" href="//wpdeveloper.com/in/upgrade-better-payment-pro"><img width="100%" src="<?php echo esc_url(BETTER_PAYMENT_ASSETS . '/img/analytics-banner.png'); ?>" alt="analytics-banner"></a></p>
                        </div>
                    </div>
                </div>
