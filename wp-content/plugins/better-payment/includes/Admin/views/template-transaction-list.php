            ...
            <?php foreach ($bp_admin_all_transactions as $bp_transaction) : ?>
                ...
                <div class="table__row">
                    ...
                    <div class="table__col col__email">
                        <p> <?php echo esc_html($bp_transaction_customer_email); ?> </p>
                    </div>
                    ...
                    <div class="table__col col__action action-buttons">
                        <a href='<?php echo esc_url(admin_url("admin.php?page=better-payment-transactions&action=view&id={$bp_transaction->id}")); ?>' class="button button--sm view-button" data-id="<?php echo esc_attr($bp_transaction->id) ?>"><?php echo esc_html__('View', 'better-payment'); ?></a>
                        <button class="button button--sm delete-button" data-id="<?php echo esc_attr( $bp_transaction->id ); ?>"><?php echo esc_html__('Delete', 'better-payment'); ?></button>
                    </div>
                </div>
            <?php endforeach; ?>
