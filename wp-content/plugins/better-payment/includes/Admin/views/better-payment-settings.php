                                            ...
                                            <div id="general" class="sidebar__tab__content show payment__options">
                                                ...
                                                <div class="payment__option">
                                                    <div class="payment__option__content">
                                                        ...
                                                        <p><?php esc_html_e('Enable Paystack if you want to accept payment via Paystack.', 'better-payment'); ?></p>
                                                    </div>
                                                    <div class="active__status">
                                                        <label class="bp-switch">
                                                ...
                                                <div class="mailing__option mb30">
                                                    ...
                                                    <div class="input__wrap">
                                                        ...
                                                        <div class="input__area">
                                                            ...
                                                            <p><?php esc_html_e('Email body for the admin email notification. ', 'better-payment'); ?> <code>[bp-all-fields]</code> <?php esc_html_e(' shortcode can be used to display all the form fields (which was used to make payments).', 'better-payment') ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mailing__option mb30">
                                                    ...
                                                    <div class="input__wrap">
                                                        ...
                                                        <div class="input__area">
                                                            ...
                                                            <p><?php esc_html_e('Email body for the customer email notification. ', 'better-payment'); ?> <code>[bp-all-fields]</code> <?php esc_html_e(' shortcode can be used to display all the form fields (which was used to make payments).', 'better-payment') ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="#" class="button add__button email-additional-headers"><span><i class="bp-icon bp-plus"></i></span> <?php esc_html_e('Additional Headers', 'better-payment'); ?></a>
                                                ...
                                                <div class="payment__options">
                                                    ...
                                                    <div class="payment__option bp-paypal-key bp-paypal-live-key <?php echo $better_payment_settings_payment_paypal_live ? 'bp-d-block' : 'bp-d-none' ?>">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php esc_html_e('PayPal live client ID is required to do Refund via PayPal. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://developer.paypal.com/developer/applications">https://developer.paypal.com/developer/applications</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paypal-key bp-paypal-live-key <?php echo $better_payment_settings_payment_paypal_live ? 'bp-d-block' : 'bp-d-none' ?>">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php esc_html_e('PayPal live secret is required to do refund via PayPal. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://developer.paypal.com/developer/applications">https://developer.paypal.com/developer/applications</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paypal-key bp-paypal-test-key <?php echo $better_payment_settings_payment_paypal_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php esc_html_e('PayPal test/sandbox client id is required to do refund via PayPal. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://developer.paypal.com/developer/applications">https://developer.paypal.com/developer/applications</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paypal-key bp-paypal-test-key <?php echo $better_payment_settings_payment_paypal_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php esc_html_e('PayPal test/sandbox secret is required to do refund via PayPal. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://developer.paypal.com/developer/applications">https://developer.paypal.com/developer/applications</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                            ...
                                            <div id="paystack" class="sidebar__tab__content better-payment-settings-payment-paystack">
                                                <div class="payment__options">
                                                    ...
                                                    <div class="payment__option bp-paystack-key bp-paystack-live-key <?php echo $better_payment_settings_payment_paystack_live ? 'bp-d-block' : 'bp-d-none' ?>">
                                                        <div class="payment__option__content">
                                                            <h4><?php esc_html_e('Live Public Key', 'better-payment'); ?></h4>
                                                            <p><?php esc_html_e('Paystack live public key is required to make payments via Paystack. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://dashboard.paystack.com/#/settings/developers">https://dashboard.paystack.com/#/settings/developers</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paystack-key bp-paystack-live-key <?php echo $better_payment_settings_payment_paystack_live ? 'bp-d-block' : 'bp-d-none' ?>">
                                                        <div class="payment__option__content">
                                                            <h4><?php esc_html_e('Live Secret Key', 'better-payment'); ?></h4>
                                                            <p><?php esc_html_e('Paystack live secret key is required to make payments via Paystack. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://dashboard.paystack.com/#/settings/developers">https://dashboard.paystack.com/#/settings/developers</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paystack-key bp-paystack-test-key <?php echo $better_payment_settings_payment_paystack_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                                                        <div class="payment__option__content">
                                                            <h4><?php esc_html_e('Test Public Key', 'better-payment'); ?></h4>
                                                            <p><?php esc_html_e('Paystack test public key is required to make payments via Paystack. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://dashboard.paystack.com/#/settings/developers">https://dashboard.paystack.com/#/settings/developers</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
                                                    ...
                                                    <div class="payment__option bp-paystack-key bp-paystack-test-key <?php echo $better_payment_settings_payment_paystack_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                                                        <div class="payment__option__content">
                                                            <h4><?php esc_html_e('Test Secret Key', 'better-payment'); ?></h4>
                                                            <p><?php esc_html_e('Paystack test secret key is required to make payments via Paystack. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://dashboard.paystack.com/#/settings/developers">https://dashboard.paystack.com/#/settings/developers</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
