                    ...
                    <div class="bp-row">
                        <div class="bp-col-lg-8 bp-col md-mb30">
                            <div class="transaction__info__wrap">
                                ...
                                if( in_array( $bp_admin_transaction->source, $allowed_sources ) ){
                                    $td_source_image_url = $bp_admin_transaction->source == 'paypal' ? BETTER_PAYMENT_ASSETS . '/img/paypal.png' : BETTER_PAYMENT_ASSETS . "/img/{$bp_admin_transaction->source}.svg";
                                    $td_source_image_alt = $bp_admin_transaction->source == 'paypal' ? 'PayPal' : ucfirst( $bp_admin_transaction->source );
                                }
                                ...
                                <div class="transaction__info">
                                    ...
                                    <ul class="informations">
                                        ...
                                        <li><span><?php esc_html_e('Email Address:', 'better-payment'); ?></span> <?php echo esc_html($td_email) ?> </li>
                                        ...
                                        <li>
                                            ...
                                            <?php if( !empty($bp_transaction_id) ) : ?>
                                                <span><?php esc_html_e('Transaction ID:', 'better-payment'); ?></span> <span id="bp_copy_clipboard_input_<?php echo esc_attr($bp_txn_counter); ?>"><?php echo esc_html($bp_transaction_id); ?></span> <span id="bp_copy_clipboard_<?php echo esc_attr($bp_txn_counter); ?>" class="bp-icon bp-copy-square bp-copy-clipboard" title="<?php esc_html_e('Copy', 'better-payment'); ?>" data-bp_txn_counter="<?php echo esc_attr($bp_txn_counter); ?>" ></span>
                                            <?php endif; ?>
                                        </li>
                                        <li class="source"><span><?php esc_html_e('Source:', 'better-payment'); ?></span> <img src="<?php echo esc_url($td_source_image_url) ?>" alt="<?php echo esc_attr( $td_source_image_alt ); ?>"></li>
                            ...
                            <div class="payment__info">
                                <div class="payment__getway">
                                    ...
                                    <div class="pay__by">
                                        ...
                                        <?php $paid_via_paystack_selected = $bp_admin_transaction->source == 'paystack' ? 'paid_via_selected' : ''; ?>
                                        ...
                                        <label class="<?php echo esc_attr($paid_via_paypal_selected); ?>">
                                            ...
                                            <span><img src="<?php echo esc_url(BETTER_PAYMENT_ASSETS . '/img/paypal.png'); ?>" alt="<?php echo esc_attr( $td_source_image_alt ); ?>"></span>
                                        </label>

                                        <?php elseif( $bp_admin_transaction->source == 'paystack' ): ?>
                                        <label class="<?php echo esc_attr($paid_via_paystack_selected); ?>">
                                            <?php esc_html_e('Payment Method:', 'better-payment'); ?>
                                            <input type="radio" name="payment__getway" <?php echo $bp_admin_transaction->source == 'paystack' ? 'checked' : ''; ?> >
                                            <span><img src="<?php echo esc_url(BETTER_PAYMENT_ASSETS . '/img/paystack.svg'); ?>" alt=""></span>
                                        </label>
                                        ...
                                        <label class="<?php echo esc_attr($paid_via_stripe_selected) ?>">
                                            ...
                                            <span><img src="<?php echo esc_url(BETTER_PAYMENT_ASSETS . '/img/stripe.svg'); ?>" alt="<?php echo esc_attr( $td_source_image_alt ); ?>"></span>
                                        </label>
                                        <?php endif; ?>
                                    </div>
