...
if (isset($options['thank-you']['sharing']) && $options['thank-you']['sharing'] === 'enabled') : ?>
    <div class="social-sharing">
        <p class="instruction">
            <?php
            echo esc_html($options['thank-you']['sharing_instruction']); ?>
        </p>
        <div class="btn-row">
            ...
            <button class="give-btn social-btn facebook-btn"
                    onclick="
							...
							">
                <?php
                esc_html_e('Share on Facebook', 'give'); ?><i class="fab fa-facebook"></i>
            </button>
            <!-- Use inline onclick listener to avoid popup blockers -->
            <button
                ...
                echo $options['thank-you']['twitter_message']; ?>`;
                    ...
                    ">
                <?php
                esc_html_e('Share on Twitter', 'give'); ?><i class="fab fa-twitter"></i>
            </button>
        </div>
    </div>
<?php
