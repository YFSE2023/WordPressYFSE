...
$introHeadline = ( ! $formInfo->post_title || 'post-new.php' === $pagenow) ? __(
    'Support Our Cause',
    'give'
) : $formInfo->post_title;
    ...
    'visual_appearance' => [
        ...
        'fields' => [
            [
                ...
                'desc' => __(
                    'The primary color is used throughout the Form Template for various elements including buttons, line breaks, and focus/hover elements. Set a color that reflects your brand or main featured image for best results.',
                    'give'
                ),
                'type' => 'colorpicker',
                'default' => '#28C77B',
            ...
            [
                ...
                'desc' => esc_html__(
                    'The default font for this donation form uses the Montserrat Google Font. The System Font option uses the system font of a particular operating system and can boost performance but impact visual appearance.',
                    'give'
                ),
                'id' => 'google-fonts',
                'type' => 'radio',
    ...
    'introduction' => [
        ...
        'fields' => [
            [
                ...
                'desc' => __(
                    'If enabled, a headline and description show for the first step of the donation process.',
                    'give'
                ),
                'id' => 'enabled',
                'type' => 'radio_inline',
            ...
            [
                ...
                'desc' => __(
                    'The headline displays at the top of step one, and defaults to the Form Title. Best practice: limit the headline to fewer than 8 words.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
            ...
            [
                ...
                'desc' => __(
                    'The description displays below the headline, and defaults to the Donation Form\'s excerpt, if present. Best practice: limit the description to short sentences that drive the donor toward the next step.',
                    'give'
                ),
                'type' => 'textarea',
                'attributes' => [
            ...
            [
                ...
                'name' => __('Image', 'give'),
                'desc' => __(
                    'Upload an eye-catching image that reflects your cause. For best results use an image in 16x9 aspect ratio at least 680x400px.',
                    'give'
                ),
                'type' => 'file',
            ],
    ...
    'payment_amount' => [
        ...
        'fields' => [
            [
                ...
                'desc' => __(
                    'The Header Label displays at the top of this step, and is designed to focus the donor\'s attention on what this step is about. Best Practice: limit this to fewer than 4 words.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
            ...
            [
                ...
                'desc' => __(
                    'Content displays before the level amounts, and is designed to provide context for those levels. Best practice: limit this to 1-2 short sentences crafted to drive the donor to decide and to remove friction.',
                    'give'
                ),
                'type' => 'textarea',
                'attributes' => [
    ...
    'payment_information' => [
        ...
        'fields' => [
            ...
            [
                ...
                'name' => __('Headline', 'give'),
                'desc' => __(
                    'The Headline introduces the section where donors provide information about themselves. Best practice: limit the headline to fewer than 5 words.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
            ...
            [
                ...
                'name' => __('Description', 'give'),
                'desc' => __(
                    'The description displays below the checkout step, and is designed to remove obstacles from donating. Best practice: use this section to reassure donors that they are making a wise decision.',
                    'give'
                ),
                'type' => 'textarea',
                'attributes' => [
    ...
    'thank-you' => [
        ...
        'fields' => [
            [
                ...
                'name' => __('Image', 'give'),
                'desc' => __(
                    'This image appears above the main thank you content. If no image is provided, a check mark icon will appear. For best results use an image in 16x9 aspect ratio at least 680x400px.',
                    'give'
                ),
                'type' => 'file',
            ],
            [
                ...
                'name' => __('Headline', 'give'),
                'desc' => __(
                    'This message displays in large font on the thank you screen. Best practice: short, sweet, and sincere works best.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
            ...
            [
                ...
                'name' => __('Description', 'give'),
                'desc' => __(
                    'The description is displayed directly below the main headline and should be 1-2 sentences. You may use <a href="http://docs.givewp.com/email-tags" target="_blank">any of the available template tags</a> within this message.',
                    'give'
                ),
                'type' => 'wysiwyg',
                'attributes' => [
            ...
            [
                ...
                'desc' => __(
                    'Sharing instructions display above the social sharing buttons. Best practice: be direct, bold, and confident here. Donors share when they are asked to.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
            ...
            [
                ...
                'desc' => __(
                    'This puts "words in the mouth" of your donor to share with their Twitter followers.',
                    'give'
                ),
                'type' => 'text',
                'attributes' => [
