...
const AnnualReceiptRow = ({annualReceipt}) => {
    ...
    return (
        <div className="give-donor-dashboard-table__row">
            <div className="give-donor-dashboard-table__column">{year.label}</div>
            <div className="give-donor-dashboard-table__column">{amount.formatted}</div>
            <div className="give-donor-dashboard-table__column">{count}</div>
