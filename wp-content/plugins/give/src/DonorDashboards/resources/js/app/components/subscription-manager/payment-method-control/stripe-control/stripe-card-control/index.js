    ...
    return (
        <div className="give-donor-dashboard-stripe-card-control">
            ...
            <div
                className={
                    focused
                        ? 'give-donor-dashboard-stripe-card-control__input give-donor-dashboard-stripe-card-control__input--focused'
                        : 'give-donor-dashboard-stripe-card-control__input'
                }
            >
                <CardElement style={{base: {fontFamily: 'Montserrat'}}} onReady={handleCardInputEvents} />
            </div>
        </div>
    );
};
