...
const DonationTable = ({donations, perPage}) => {
    ...
    return (
        <Table
            header={
                <Fragment>
                    <div className="give-donor-dashboard-table__column">{__('Donation', 'give')}</div>
                    <div className="give-donor-dashboard-table__column">{__('Campaign', 'give')}</div>
                    <div className="give-donor-dashboard-table__column">{__('Date', 'give')}</div>
                    <div className="give-donor-dashboard-table__column">{__('Status', 'give')}</div>
                </Fragment>
            }
            rows={<Fragment>{donationRows}</Fragment>}
            footer={
                <Fragment>
